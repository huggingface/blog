...
## Finetuning mmBERT with Sentence Transformers

The finetuning sections above cover encoder tasks; if you want to turn mmBERT into a multilingual embedding, reranker, or sparse model, these blogposts walk through the full training pipeline:

- [Training and Finetuning Embedding Models with Sentence Transformers](https://huggingface.co/blog/train-sentence-transformers): finetune mmBERT as a multilingual dense embedding model.
- [Training and Finetuning Reranker Models with Sentence Transformers](https://huggingface.co/blog/train-reranker): finetune mmBERT as a multilingual Cross Encoder reranker.
- [Training and Finetuning Sparse Embedding Models with Sentence Transformers](https://huggingface.co/blog/train-sparse-encoder): finetune mmBERT as a multilingual SPLADE sparse encoder.
