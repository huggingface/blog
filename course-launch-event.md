...
thumbnail: /blog/assets/32_course_launch/speakers_day1.png
---
...
<img src="/blog/assets/32_course_launch/amazon_logo_dark.png" width=30% class="hidden dark:block"> 
<img src="/blog/assets/32_course_launch/amazon_logo_white.png" width=30% class="dark:hidden">
</div>
...
>
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/thom_wolf.png" width=50%>
    ...
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/meg_mitchell.png" width=50%>
    ...
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/jakob_uszkoreit.png" width=50%>
    ...
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/jay_alammar.png" width=50%>
    ...
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/matthew_watson.png" width=50%>
    ...
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/chen_qian.png" width=50%>
    ...
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/mark_saroufim.png" width=50%>
...
>
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/lewis_tunstall.png" width=50%>
    ...
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/matthew_carrigan.png" width=50%>
    ...
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/sylvain_gugger.png" width=50%>
    ...
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/lucile_saulnier.png" width=50%>
    ...
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/merve_noyan.png" width=50%>
    ...
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/abubakar_abid.png" width=50%>
    ...
    <div class="text-center flex flex-col items-center">
        <img src="/blog/assets/32_course_launch/philipp_schmid.png" width=50%>
