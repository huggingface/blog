...
Exploring with different precisions (`torch.float16`, `8bit`, and `4bit`), Falcon 180B preserves similar metrics across benchmarks. See results in the [Open LLM Leaderboard](https://huggingface.co/spaces/HuggingFaceH4/open_llm_leaderboard).
