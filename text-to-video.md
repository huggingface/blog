...
Using Hugging Face Diffusers, you can easily download, run and fine-tune various pretrained text-to-video models by Alibaba / DAMO Vision Intelligence Lab. See a full list of models over [here](https://huggingface.co/damo-vilab). Note that we are currently working on integrating other exciting works into Diffusers and 🤗 Transformers.
