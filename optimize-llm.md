...
Please note that the whole Flash Attention is a bit more complex and is greatly simplified here as going in too much depth is out of scope for this notebook. The reader is invited to take a look at the well-written [Flash Attention paper](https://huggingface.co/papers/2205.14135) for more details.
...
Researchers have proposed two methods that allow to significantly reduce the memory cost of storing the key-value cache:
  ...
  1.  [Multi-Query-Attention (MQA)](https://huggingface.co/papers/1911.02150)
...
Also, the checkpoint used in this notebook - `bigcode/octocoder` - makes use of MQA.
  ...
  2.  [Grouped-Query-Attention (GQA)](https://huggingface.co/papers/2305.13245)
