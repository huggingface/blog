...
Because image segmentation is a type of classification, the network architectures that are used for image classification and image segmentation are very similar. In 2014, Long et al. used convolutional neural networks to create a [fully convolutional network](https://arxiv.org/abs/1411.4038) for image segmentation. More recently, Transformers have been used for image classification (e.g. [ViT](https://huggingface.co/blog/fine-tune-vit)), and now they're now also being used for image segmentation.
