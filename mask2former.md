...
- **panoptic segmentation**, introduced in 2018 by [Kirillov et al.](https://huggingface.co/papers/1801.00868), aims to unify instance and semantic segmentation, by making models simply identify a set of "segments", each with a corresponding binary mask and class label. Segments can be both "things" or "stuff". Unlike in instance segmentation, no overlap between different segments is possible.
