...
In this case, you are using an unlabeled triplets dataset, the fourth case above.

You can index and explore the Hugging Face datasets easily (see the [Documentation](https://huggingface.co/docs/datasets/index)):
...
The next step is to choose a suitable loss function that can be used with the current format of the data.
