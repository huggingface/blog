...
Please note that both Megatron-LM and DeepSpeed have both a Pipeline Parallelism and BF16 Optimizer implementation, but we used the ones from DeepSpeed as they are integrated with ZeRO.
