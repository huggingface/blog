...
- Pretrained only on open-source community-shared![Uploading collage_small.gif…]()
 datasets under the [lerobot](https://huggingface.co/datasets?other=lerobot&sort=trending) tag.
