...
<em>TL;DR</em>: Many models such as `LlaMA 3.1-8B` lack a smaller version to use for assisted generation. It's now possible to use a small model **from any other modal family** to accelerate inference by **1.5x-2.0x**!
