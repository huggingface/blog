...
- [Argilla 2.0 Chatbot: Leveraging Distilabel to fine-tune a custom embedding model](#argilla-2.0-chatbot:-leveraging-distilabel-to-fine-tune-a-custom-embedding-model)
  - [TL;DR](#tldr)
