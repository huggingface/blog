...
- [Using SD3.5 with Diffusers](#Using SD3.5 with Diffusers)
- [Performing inference with quantization](#Performing inference with quantization)
- [Training LoRAs with quantization](#Training LoRAs with quantization)
- [Using single-file loading](#Using single-file loading)
...
Diffusers natively support working with [`bitsandbytes`](https://github.com/bitsandbytes-foundation/bitsandbytes) quantization which allows more memory-optimized inference. 
