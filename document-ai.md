...
Many successors of LayoutLM adopt a generative, end-to-end approach. This started with the [Donut](https://huggingface.co/docs/transformers/model_doc/donut) model, which simply takes the image of a document as input, and produces text as an output, not relying on any separate OCR engine. 
