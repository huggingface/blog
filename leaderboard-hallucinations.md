...
**UPDATE** -- We released a paper on this project; you can find it in arxiv: [The Hallucinations Leaderboard -- An Open Effort to Measure Hallucinations in Large Language Models](https://huggingface.co/papers/2404.05904). Here's also the [Hugging Face paper page](https://huggingface.co/papers/2404.05904) for community discussions.
...
Hallucinations in LLMs can be broadly categorised into factuality and faithfulness hallucinations ([reference](https://huggingface.co/papers/2311.05232)).
