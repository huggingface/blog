...
1. **标注的 PII 数据集**: 例如由 Ai4Privacy 提供的 [PII-Masking-300k](https://huggingface.co/datasets/ai4privacy/pii-masking-300k)，这类数据集专门用于训练 PII 检测模型。这些模型用于检测和掩盖 PII，可以帮助进行在线内容审核或提供匿名化的数据库。
