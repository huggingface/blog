...
There are many more different methods to reduce memory usage by key-value cache, including [MultiQueryAttention](https://huggingface.co/papers/1911.02150), [GroupedQueryAttention](https://huggingface.co/papers/2305.13245) or recent [kv cache retrieval](https://huggingface.co/papers/2403.09054) methods. While some of these methods are bound to the model architecture choices, others can be applied post-training. Quantization is one of such post-training optimization techniques and we can draw the following conclusion from our short blogpost:
