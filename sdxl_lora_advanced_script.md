...
Specifically, for this analysis we used the following datasets:
* Huggy Mascot Dataset (using Chunte-Lee’s amazing artwork)
Contains 31 images 
* Y2K Web Dataset (scraped from the internet)
Contains 27 images 
* 3D Icons Dataset (free licensed images downloaded from unsplash) 
Contains 23 images 
* Linoy face Datasets 
