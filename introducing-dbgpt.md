...
thumbnail: /blog/assets/148_introducing-dbgpt/DB-GPT.png
authors:
- user: csunny 
- user: Aries-ckt
- user: yhjun1026
...
- Unified vector storage/indexing of knowledge base
    ...
    - Support for unstructured data such as PDF, Markdown, CSV, and WebURL、Docs、HTML
    - Milti LLMs Support
...
<p align="center">
  <img src="assets/148_introducing-dbgpt/DB-GPT.png" width="680px" />
</p>
...
# create models path at DB-GPT project path, and download models from huggingface.
mkdir models
...
# Conclusion
DB-GPT aims to empower local LLMs with the capacity to acquire knowledge and wield tools via a privatized deployment of the LLMs, allowing for interaction with your data and environment. This solution guarantees that your data remains 100% private and secure, with zero chance of data leakage.
