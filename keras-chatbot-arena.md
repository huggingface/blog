...
|**The current year is 2026.**|`action.add_calendar_entry("Meeting with Fred", date="2026-11-11", time="17:00", duration=30)`|
|**I'm going to a rock concert in the evening of<br/>the same day at 8pm. Add a calendar entry for that.**|`action.add_calendar_entry("Rock Concert", date="2026-11-11", time="20:00", duration=30)`|
|**Set the duration to 3 hours.**|`action.add_calendar_entry("Rock Concert", date="2026-11-11", time="20:00", duration=60*3)`|
|**Add a meeting with Paul on the next day at 8am. 1/2h.**|`action.add_calendar_entry("Meeting with Paul", date="2026-11-12", time="08:00", duration=30)`|
|**Cancel the meeting with Fred.**|`action.remove_calendar_entry("Meeting with Fred", "2026-11-11", "17:00")`|
...
| <div style="text-align:right">Current year is 2026</div>      |<big>🥦</big>  ||<div style="text-align:right">Current year is 2026</div>    |<big>🍄</big>  ||<div style="text-align:right">Current year is 2026</div>     |<big>🍄</big>|
...
| :---                                                         | :----:         | :----: | :----                                           | :----:         |:----:| :----                                                  | :----: |
| **Add a meeting with Fred…**                                 |<big>✔︎ 🍄</big> ||**Add a meeting with Fred…**                             |<big>✔︎ 🍄</big> ||**Add a meeting with Fred…**                                  |<big>✔︎ 🍄</big>|
| <div style="text-align:right">current year is 2026</div> |<big>🥦</big>   ||<div style="text-align:right">Just the API call…</div>   |<big>🥦 🍄</big>||<div style="text-align:right">The time is wrong…</div>        |<big>🥦</big> (🍄)|
...
| **Set the duration to 3 hours**                              |<big>✔︎ 🍄</big> ||<div style="text-align:right">Current year is 2026</div> |<big>✔︎</big>    ||<div style="text-align:right">Current year is 2026</div>      |<big>🥦</big> (🍄)|
...
| :---                                                         | :----:              | :----: | :----                                           | :----:          |:----:| :----                                                | :----: |
|**Add a meeting with Fred…**                                  |<big>✔︎ 🍄</big>      ||**Add a meeting with Fred…**                             |<big>✔︎ 🍄</big> ||**Add a meeting with Fred…**                                 |<big>✔︎ 🍄</big>|
|<div style="text-align:right">current year is 2026</div>      |<big>🥦</big> (🍄)   ||<div style="text-align:right">current year is 2026</div> |<big>🥦</big>   ||<div style="text-align:right">Respect the date format…</div> |<big>🥦 🍄</big>|
...
|**I'm going to a rock concert…**                              |<big>✔︎</big> (🍄)    ||**Set the duration to 3 hours**                          |<big>🔥🔥</big> ||<div style="text-align:right">Current year is 2026</div>     |<big>🥦 🍄</big>|
