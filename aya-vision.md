...
With the release of the [Aya Vision family](https://huggingface.co/collections/CohereForAI/c4ai-aya-expanse-671a83d6b2c07c692beab3c3), our new **8B** and **32B** parameter vision-language models (VLMs), we are addressing one of the biggest challenges in AI: *bringing multilingual performance to multimodal models*. 
