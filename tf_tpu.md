...
> 💡 It’s easy to use 🤗 datasets to host your own text datasets. Refer to [this guide](https://huggingface.co/docs/datasets/create_dataset) to learn more.
