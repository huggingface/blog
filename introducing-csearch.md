...
:star2: Check out this awesome [[demo]](https://huggingface.co/spaces/joaogante/contrastive_search_generation) generously supported by Huggingface ([@huggingface](https://github.com/huggingface) :hugs:) which compares contrastive search with other popular decoding methods. Many thanks to our awesome collaborators at Huggingface ([@gante](https://github.com/gante), [@patrickvonplaten](https://github.com/patrickvonplaten), [@sgugger](https://github.com/sgugger))!
