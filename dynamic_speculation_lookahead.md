...
To revert to the **heuristic** or **constant** (as in [Leviathan et al.](https://arxiv.org/pdf/2211.17192)) approaches, simply set 'num_assistant_tokens_schedule' to 'heuristic' or 'constant', respectively, with the following configuration:
```python
