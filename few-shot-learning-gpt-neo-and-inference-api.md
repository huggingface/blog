...
GPT⁠-⁠Neo is a family of transformer-based language models from [EleutherAI](https://www.eleuther.ai/projects/gpt-neo/) based on GPT architecture. [EleutherAI](https://www.eleuther.ai/projects/gpt-neo/) primary goal is to train an equivalent model to the full-sized GPT⁠-⁠3 and make it available to the public under an open license.
